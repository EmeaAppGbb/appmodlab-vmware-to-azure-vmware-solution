...
#
# This is the Harbor Retail application-specific copy of the AVS provisioning
# template. It mirrors avs-deployment/terraform/avs-provision.tf and can be
# customized for the Harbor Retail workload environment.
# =============================================================================
